...
PYTHONPATH=${BASE_DIR}:${BASE_DIR}/third-party/gtd/ python ${BASE_DIR}/scripts/main-decomposable.py ${BASE_DIR}/configs/rlong/best-tangrams.txt --weights_from_epoch $1
